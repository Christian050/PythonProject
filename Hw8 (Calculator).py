...
class Calculator:
    def __init__(self):
        ...
        self.window.title("Christian's Calculator")
...
# To save as exe
# Open terminal, enter "pip install pyinstaller
# pyinstaller --onefile -w (name of python file)
# Open in Explorer (located in dist as .exe)
# Click to open