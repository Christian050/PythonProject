...
def RealTimeCurrencyConversion():
    ...
    api_key = "ZKU0II6P6MEKRI4K"

    # base_url variable store base url
    base_url = r"https://www.alphavantage.co/query?function=FX_DAILY&from_symbol=EUR&to_symbol=USD&apikey=ZKU0II6P6MEKRI4K"
...
# parsing the required information
    Exchange_Rate = float(result["Currency Exchange Rate"]
                                ['5. Exchange Rate'])
...
if __name__ == "__main__":
    ...
    CurrenyCode_list = ["GHC", "USD", "CAD", "CNY", "DKK", "EUR"]
    ...
    button1 = Button(root, text="Convert", bg="White", fg="black",
    ...
    button2 = Button(root, text="Clear", bg="White",
